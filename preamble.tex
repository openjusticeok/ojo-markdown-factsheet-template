...
\newcommand{\ojologo}[0]{
  \begin{figure}
    \hspace{-0.12in}
    \includegraphics[width=1.5in]{design/cropped-OJO_Logo_Black.jpg}
    \label{fig:boat1}
  \end{figure}
}
...
\newcommand{\contactinfo}[0]{
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \draw 
      ...
      {\color{gray}Open Justice OK \space
      \color{yellow}$\blacksquare$ \space
      \color{gray}907 S Detroit Ave \space
      \color{yellow}$\blacksquare$ \space
      \color{gray}Tulsa, OK 74120 \space
      \color{yellow}$\blacksquare$ \space
      \color{gray}918.794.3944 \space
      \color{yellow}$\blacksquare$ \space
      \textcolor{black}{www.openjustice.okpolicy.org}};
  \end{tikzpicture}
}
