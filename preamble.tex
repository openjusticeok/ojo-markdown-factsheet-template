...
\newcommand{\footer}[0]{
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \draw 
      ...
      {\thepage \space \space \rule{475pt}{3pt}
      \textcolor{black}{OpenJusticeOK.org}};
  \end{tikzpicture}
}
...
% heading 1
\newcommand{\heading}[1]{
  {\color{yellow}\rule{5pt}{15pt}} \textbf{\LARGE{\\} \large{#1}}
}

%code to try new heading
\newtcolorbox{newhead}[1][]{%
  enhanced,
  frame hidden,
  colback=white,
  left=0pt,
...
%code to try new heading SECOND TIME -- edit comment later
\newtcbox{newheadtwo}[1][]{%
  enhanced,
  frame hidden,
  colback=white,
